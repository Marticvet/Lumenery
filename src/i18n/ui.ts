...
export const ui = {
    de: {
        ...
        form: {
            title: "Kontaktformular", productSelection: "Deine Auswahl", product: "Produkt", quantity: "Menge", name: "Dein Name", email: "Deine E-Mail", address: "Deine Adresse (optional)", phone: "Deine Telefonnummer (optional)", message: "Dein Anliegen", submit: "Senden", sending: "Wird gesendet …",
            ...
            success: "Danke! Deine Anfrage ist bei uns eingegangen.", reference: "Deine Referenznummer", confirmation: "Wir haben eine Bestätigung an {email} gesendet.", confirmationPending: "Deine Anfrage ist angekommen. Die Bestätigungs-E-Mail konnte jedoch nicht gesendet werden. Bitte bewahre deine Referenznummer auf.", manage: "Zum Ändern oder Stornieren antworte auf die Bestätigungs-E-Mail und nenne diese Referenznummer.",
            ...
            errors: { name: "Bitte gib deinen Namen ein (maximal 140 Zeichen).", email: "Bitte gib eine gültige E-Mail-Adresse ein.", address: "Bitte kürze die Adresse auf maximal 500 Zeichen.", phone: "Bitte prüfe deine Telefonnummer (maximal 60 Zeichen).", message: "Bitte beschreibe dein Anliegen (maximal 5.000 Zeichen).", product: "Bitte wähle ein gültiges Produkt.", quantity: "Bitte gib eine Menge zwischen 1 und 9.999 ein." },
        },
    ...
    en: {
        ...
        form: {
            title: "Contact form", productSelection: "Your selection", product: "Product", quantity: "Quantity", name: "Your name", email: "Your email", address: "Your address (optional)", phone: "Your phone number (optional)", message: "Your enquiry", submit: "Send enquiry", sending: "Sending …",
            notice: "Your details are used only to respond to your enquiry.", privacy: "Privacy information",
            success: "Thank you! We've received your enquiry.", reference: "Your reference number", confirmation: "We've sent a confirmation to {email}.", confirmationPending: "Your enquiry has arrived, but we couldn't send the confirmation email. Please keep your reference number.", manage: "To change or cancel it, reply to the confirmation email and include this reference number.",
            ...
            errors: { name: "Please enter your name (up to 140 characters).", email: "Please enter a valid email address.", address: "Please keep the address within 500 characters.", phone: "Please check your phone number (up to 60 characters).", message: "Please describe your enquiry (up to 5,000 characters).", product: "Please select a valid product.", quantity: "Please enter a quantity from 1 to 9,999." },
        },
    ...
    bg: {
        ...
        form: {
            title: "Форма за контакт", productSelection: "Твоят избор", product: "Продукт", quantity: "Количество", name: "Твоето име", email: "Твоят имейл", address: "Твоят адрес (незадължително)", phone: "Твоят телефон (незадължително)", message: "Твоето запитване", submit: "Изпрати запитване", sending: "Изпращане …",
            notice: "Данните ти се използват единствено за обработване на запитването.", privacy: "Информация за поверителността",
            success: "Благодарим! Получихме твоето запитване.", reference: "Твоят референтен номер", confirmation: "Изпратихме потвърждение на {email}.", confirmationPending: "Получихме запитването, но не успяхме да изпратим имейла за потвърждение. Моля, запази референтния номер.", manage: "За промяна или отказ отговори на имейла за потвърждение и посочи този референтен номер.",
            ...
            errors: { name: "Моля, въведи името си (до 140 знака).", email: "Моля, въведи валиден имейл адрес.", address: "Моля, съкрати адреса до 500 знака.", phone: "Моля, провери телефонния номер (до 60 знака).", message: "Моля, опиши запитването си (до 5 000 знака).", product: "Моля, избери валиден продукт.", quantity: "Моля, въведи количество от 1 до 9 999." },
        },
